...
export class ClintComponent implements OnInit {
  ...
  goToActiveStrategy(data: any) {
    ...
    // console.log("goToActiveStrategy goToActiveStrategy",data)
    this.clientService.activeBots(obj).subscribe((res) => {
      console.log("goToActiveStrategy goToActiveStrategy", res)
    })
  }
